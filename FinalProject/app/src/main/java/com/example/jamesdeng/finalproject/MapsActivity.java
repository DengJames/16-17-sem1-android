...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    double latitude;
    double longitude;
    private int PROXIMITY_RADIUS = 10000; // set the radius within 10000 meters
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            String userInput = pref3.getString("itemCategory", "");

            @Override
            public void onClick(View v) {
                Log.d("onClick", "Button is Clicked");
                mMap.clear();
                String url = getUrl(latitude, longitude, userInput);
...
//                Toast.makeText(MapsActivity.this,"Nearby " + userInput, Toast.LENGTH_LONG).show();
            }
        });
